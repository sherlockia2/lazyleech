...
rsslink = list(filter(lambda x: x, map(str, os.environ.get("NYAA_RSS_LINKS", "https://nyaa.si/?page=rss&q=%5BSubsPlease%5D+Boku+no+Hero+Academia+480p&c=1_2&f=0").split(' '))))
